...
class Collider {
 public:
  ...
  RigidBody* body; /* the rigid body component of the object this collider is
                      attached to */
...
class OBBCollider : public Collider {
 ...
 public:
  ...
  OBBCollider(const glm::vec3& halfSizes,
  ...
  bool TestIntersectionRay(glm::vec3 origin,
                           glm::vec3 direction,
                           float& intDistance,
                           glm::vec3& intPoint);
...
class PotentialCollisionDetector {
 private:
  std::vector<PlaneCollider*>
      planeVector; /* plane colliders assigned to this detector */

 public:
  std::vector<OBBCollider*>
      obbVector; /* OBB colliders assigned to this detector */
