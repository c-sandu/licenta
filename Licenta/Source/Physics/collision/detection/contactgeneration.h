...
namespace GJKEPA
{
	...
	public:
		...
		MinkowskiDiffPt(glm::vec3 v, glm::vec3 supA, glm::vec3 supB) : v(v), supA(supA), supB(supB) {}
		MinkowskiDiffPt() {}
	};
	...
	public:
		...
		void set(MinkowskiDiffPt a, MinkowskiDiffPt b, MinkowskiDiffPt c, MinkowskiDiffPt d) { numVertices = 4; this->a = a; this->b = b; this->c = c; this->d = d; }
		/* sets the simplex as a triangle */
		void set(MinkowskiDiffPt a, MinkowskiDiffPt b, MinkowskiDiffPt c) { numVertices = 3; this->a = a; this->b = b; this->c = c; }
		/* sets the simplex as a line */
		void set(MinkowskiDiffPt a, MinkowskiDiffPt b) { numVertices = 2; this->a = a; this->b = b; }
		/* sets the simplex as a point */
		void set(MinkowskiDiffPt a) { numVertices = 1; this->a = a; }
	...
	public:
		...
		Triangle(const MinkowskiDiffPt &a, const MinkowskiDiffPt &b, const MinkowskiDiffPt &c) {
			this->a = a;
			this->b = b;
			this->c = c;
...
/* describes a collision point generator that computes all collision points between
	the pairs of potential collisions */
class CollisionsGenerator
{
public:
	std::vector<PotentialCollision*> *potentialCollisions; /* pointer to the potential collision vector created in the broad phase */
	std::vector<CollisionPoint*> collisionsPoints; /* vector of all collision points in the scene */
