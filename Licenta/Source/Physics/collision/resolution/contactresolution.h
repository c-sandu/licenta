...
public:
	...
	Contact *getFastestContact(); /* returns the fastest contact (with the lowest desired delta velocity) */
...
private:
	...
	/* updates the positions of the given contact and all the other contacts in its manifold */
	static void applyPositionUpdate(ContactManifold &manifold, Contact *deepestContact);
	/* updates the velocities of the given contact and all the other contacts in its manifold */
	static void applyVelocityUpdate(ContactManifold &manifold, Contact *fastestContact);
