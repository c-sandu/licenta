...
void TestImGui::Update(float deltaTime)
{
...
void TestImGui::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
...
void TestImGui::OnInputUpdate(float deltaTime, int mods)
{
	deltaTime *= PhysicsSettings::get().timeScale;
...
void TestImGui::OnKeyPress(int key, int mods)
{
	// add key press event
	if (key == GLFW_KEY_P)
	{
...
void TestImGui::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
...
void TestImGui::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
}
